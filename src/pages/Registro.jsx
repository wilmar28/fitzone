...
function Registro({ onRegister }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const name = `${form.nombre} ${form.apellido}`.trim()
      await registerUser(name, form.email, form.password)
  ...
  return (
    <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1.2rem' }}>
      <form onSubmit={handleSubmit} style={{
        ...
        />
        {errors.name && <div style={{ color: '#fca5a5', fontSize: '0.75rem', marginTop: '-0.8rem', marginBottom: '1rem' }}>{errors.name}</div>}
        ...
        />
        {errors.email && <div style={{ color: '#fca5a5', fontSize: '0.75rem', marginTop: '-0.8rem', marginBottom: '1rem' }}>{errors.email}</div>}
        ...
        />
        {errors.password && <div style={{ color: '#fca5a5', fontSize: '0.75rem', marginTop: '-0.8rem', marginBottom: '1rem' }}>{errors.password}</div>}
