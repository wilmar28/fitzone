...
function ResetPassword() {
  ...
  useEffect(() => {
    const initSession = async () => {
      ...
      try {
        ...
        setError('Error al establecer la sesión: ' + err.message)
      }
    }
  ...
  const handleSubmit = async (event) => {
    ...
    if (!sessionReady) {
      setError('La sesión no está lista. Intenta de nuevo.')
      return
    }
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            <div style={{
              ...
              height: 48,
              borderRadius: '50%',
              background: 'conic-gradient(#ff4b63, #ff8a00, #ff4b63)',
              margin: '0 auto 1rem'
            }}>
            </div>
          </div>
          ...
          <p style={{ color: '#94a3b8', fontSize: '0.85rem', textAlign: 'center', margin: 0 }}>
            Estamos configurando tu sesión de seguridad
          </p>
        </div>
      ) : (
